...
[picture color_table] = imread('1.bmp');
...
figure
image(picture)
title('Per pixel values in 6 bit bitmap')
...
title('6 bit bitmap displayed using color table')
